...
Cashu's specifications are called **NUTs**, for Notation, Usage and Terminology, and they are the
...
of who owes the underlying bill and when it falls due, which plain Cashu units do not have. That is
