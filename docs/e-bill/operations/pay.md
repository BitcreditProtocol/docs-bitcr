...
the funds received, and a `status` of waiting, paid, rejected or expired, with timestamps.

Because it is a list, a participant who has been paid before on the same bill, whether as a seller
in an earlier sale or a recourser in an earlier recourse, keeps that history.
