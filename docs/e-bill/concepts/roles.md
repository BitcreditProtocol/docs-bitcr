...
| **Holder** | Whoever holds the bill now: the payee at first, then the endorsee of the last endorsing action. | No — changes with every endorsement, sale, mint or recourse |
...
defines **six** roles — Drawer, Payer, Holder, Contingent, Recoursee, Buyer — because those are
...
- **Contingent** — carries liability, not permissions. What matters for a contingent participant
  is the roles they held earlier, which is where their payment history and states come from.
...
- **Drawer is also the drawee** — a self-drafted bill. Nobody can be recoursed against the
