...
Files — an identity document, a profile picture, the invoices attached to a bill — are not kept
...
- **The files themselves**, if you care about them independently. They live on relays, encrypted;
  a relay that drops them is not a loss of the bill's validity — the hashes in the chain stand
